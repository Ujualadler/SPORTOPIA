                            ...
                            <div className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                <div className="w-full flex flex-col justify-start items-start space-y-8">
                                    ...
                                    <div className="flex justify-start items-start flex-col space-y-2">
                                        ...
                                        <p className="text-sm leading-none text-gray-800">
                                            <span className="text-gray-600">User Number:</span> {data.user.contactNumber}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex justify-between mr-16 space-x-8 items-start w-full">
                                    <p className="text-base xl:text-lg leading-6">
                                    <span className="text-gray-500  font-bold">Name: </span> <span className="text-red-500  ">{data.user.name}</span>
                                    </p>
                                    <p className="text-base xl:text-lg leading-6 text-gray-500 font-bold"><span className="text-gray-600">Total amount: </span>₹{data.totalAmount}</p>
