                ...
                <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div className="flex flex-col justify-start items-start bg-gray-900 bg-opacity-70 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                        ...
                        <div className="mt-6 md:mt-0 flex justify-start flex-col md:flex-row  items-start md:items-center space-y-4  md:space-x-6 xl:space-x-8 w-full ">
                            ...
                            <div className="  flex j items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                ...
                                <div className="flex justify-between space-x-8 items-start w-full">
                                    ...
                                    <span className="text-gray-200 font-bold">Total:</span> <span className="text-red-700 font-bold">₹{data.totalAmount}</span>
                                    </p>
                                    ...
                                    <p className="text-base xl:text-lg leading-6 text-red-700 font-bold"><span className="text-slate-200">Advance amount paid:</span>₹{data.totalAdvance}</p>
                                    <p onClick={()=>openReview(data.turf._id)} className="text-base xl:text-lg leading-6 text-white hover:text-red-700 font-bold">ADD REVIEW</p>
                                </div>
                            </div>
                        </div>
                    </div>
