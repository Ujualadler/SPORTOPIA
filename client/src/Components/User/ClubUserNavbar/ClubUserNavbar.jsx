    ...
    <>
      <div className="flex justify-center bg-black m-2">
        <div className="flex md:w-3/4 w-full bg-black ml-1 mr-1  md:m-2 md:p-2  md:font-bold md:text-lg">
          <div onClick={()=>navigate('/yourTournaments')} className="bg-black relative w-full md:w-auto md:flex-1 flex items-center justify-center h-48 md:h-56 font-heading text-white uppercase md:tracking-widest hover:opacity-75">
          ...
          <div onClick={()=>navigate('/chat')}  className="bg-black relative w-full md:w-auto md:flex-1 flex items-center justify-center h-48 md:h-56 font-heading text-white uppercase md:tracking-widest hover:opacity-75">
