					...
					<div className="w-full px-4 md:w-1/2 ">
						...
						<div className="lg:pl-20">
							<div className="mb-8 mt-1">
								<h2 className="w-full flex text-xl font-semibold mb-4 dark:text-gray-600">
									<font className="inline-block w-2/5 text-gray-800 mr-3 font-bold font-poppins">
										TYPE
									</font>
									<span>{data ? data.turfType : ""}</span>
								</h2>
								<div className=" flex">
									<h2 className="w-full text-xl font-semibold align-center mb-4 flex dark:text-gray-600">
										<div className="w-2/5 text-gray-800 mr-3 font-bold font-poppins">
											TIMING
										</div>
										<span>
								...
								<h2 className="w-full mr-6 text-xl font-semibold mb-4 dark:text-gray-600">
									<font className="inline-block w-2/5 text-gray-800 mr-3 font-bold font-poppins">
										PHONE
									</font>
								...
								<div className="w-full">
									<button
										className="self-start mr-6 text-xl font-semibold text-center w-auto mb-4 dark:text-gray-800 cursor-pointer"
										onClick={toggleDetails}
									>
										<font className="text-white mr-3 px-3 pb-1 font-semibold font-poppins rounded-md bg-black ">
											{showDetails ? "HIDE ADDRESS" : "SEE ADDRESS"}
										</font>
									</button>
									{showDetails && (
										<>
											<h2 className="w-full flex mr-6 text-xl font-semibold mb-4 text-gray-600">
												<font className="inline-block w-2/5 text-gray-800 mr-3 font-bold font-poppins">
													STREET
												</font>
												<span>{data ? data.street : ""}</span>
											</h2>
											<h2 className="w-full mr-6 text-xl font-semibold mb-4 text-gray-600">
												<font className="inline-block w-2/5 text-gray-800 mr-3 font-bold font-poppins">
													CITY
												</font>
												{data ? data.city : ""}
								...
								<p className="mt-4 mb-4 text-xl font-bold font-poppins text-gray-700 dark:text-gray-800">
								...
								<p className="mb-4 text-xl font-bold font-poppins  text-gray-700 dark:text-gray-800">
								...
								<p className="mt-4 mb-4 text-xl font-bold text-gray-800 font-poppins dark:text-gray-800">
								...
								<div className="inline-block mb-8 text-xl font-bold font-poppins text-gray-800 ">
									<span className="mr-3 inline-block w-2/5 mb-4">
										TIME SLOTS
									</span>
